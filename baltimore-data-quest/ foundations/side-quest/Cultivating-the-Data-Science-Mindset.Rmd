...
One example is, **"is crime bad in this neighborhood?"** that's a good question but lets deepen that question. Into **"Why is crime bad in this neighborhood?"** see how one word can change the direction of your question. Forcing your mind to always think deeper then a surface level question.

Here's a great example: "whats happening in this neighborhood? this opens multiple paths to amazing insights on any CSA.

-   Teach the difference between **descriptive**, **diagnostic**, and **predictive** questions.

✅ **Challenge Activity:** Pick one BNIA indicator (like “Percent of Households with No Internet”) and write 3 data-driven questions about it.
...
✅ **Challenge Activity:** Take a common claim from the media (“Crime is increasing in my city”). Use BNIA to find supporting or contradicting data exploring either side.
...
✅ **Challenge Activity:** Watch a scene from a show (or a TikTok trend). Write what the creators want the viewer to feel. Then, think: what story would the **data** behind it tell?
